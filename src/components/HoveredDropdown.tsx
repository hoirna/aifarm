...
const Dropdown: React.FC<DropdownProps> = ({ title, sections = [] }) => {
  return (
    <div className="dropdown flex flex-row items-start justify-center space-x-16  p-6 bg-white shadow-md h-auto">
      {/* Title Section */}
      ...
      {sections.length > 0 ? (
        sections.map((section, index) => (
          <div key={index} className="space-y-4 relative">
            ...
            <div className="font-bold text-gray-900 sticky top-6 bg-white z-20">
              {section.title}
            </div>
